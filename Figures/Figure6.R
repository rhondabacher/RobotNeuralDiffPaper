...
if( PP < .001) {PP <- "< .001"}
  PP
library(ggplot2)
pdf("MANUSCRIPT/March2019/FIGURES/PLOTS/histogram_commonGenes_slopeUP_Figure6.pdf", height=6, width=7.5)
par(mar=c(6,6,3,1))
...
pdf("MANUSCRIPT/March2019/FIGURES/PLOTS/boxPlot_commonGenes_slopeUP_Figure6.pdf", height=6, width=6)
par(mar=c(5,7,2,1), mgp = c(5, .5, 0))
pirateplot(formula = Slope ~ Species,
           data = longdata,
           xlab = "",
...
wilcox.test(X,Y)
PP <- round(ks.test(X,Y)$p.value, 3)
if( PP < .001) {PP <- "< .001"}

library(ggplot2)
pdf("MANUSCRIPT/March2019/FIGURES/PLOTS/histogram_commonGenes_slopeDown_Figure6.pdf", height=6, width=7.5)
par(mar=c(6,6,3,1))
...
pdf("MANUSCRIPT/March2019/FIGURES/PLOTS/boxPlot_commonGenes_slopeDown_Figure6.pdf", height=6, width=6)
par(mar=c(5,8,2,1), mgp = c(6, .5, 0))
pirateplot(formula = Slope ~ Species,
           data = longdata,
           xlab = "",
